...
func (bldr *stepContextBuilder) build() *domain.StepsCtx {
	return &domain.StepsCtx{
		GlobalCtx:  b.globalContext().build(),
		StepDir:    ".",
		OutputFile: "output",
...
func (*globalContextBuilder) build() *domain.GlobalCtx {
	return &domain.GlobalCtx{
		WorkDir:    ".",
