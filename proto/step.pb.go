...
type Status struct {
	...
	Result    *StepResult            `protobuf:"bytes,7,opt,name=result,proto3" json:"result,omitempty"`
}
...
func (x *Status) GetResult() *StepResult {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_step_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x81, 0x02, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x65, 0x12, 0x29, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x62, 0x73, 0x2a, 0x8b, 0x01, 0x0a, 0x15, 0x53, 0x74, 0x65, 0x70, 0x52, 0x65, 0x66, 0x65, 0x72,
	...
	0x10, 0x03, 0x12, 0x07, 0x0a, 0x03, 0x6f, 0x63, 0x69, 0x10, 0x04, 0x12, 0x08, 0x0a, 0x04, 0x64,
	0x69, 0x73, 0x74, 0x10, 0x05, 0x12, 0x0b, 0x0a, 0x07, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63,
	0x10, 0x06, 0x12, 0x0c, 0x0a, 0x08, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x64, 0x65, 0x66, 0x10, 0x07,
	...
	0x61, 0x72, 0x72, 0x61, 0x79, 0x10, 0x06, 0x22, 0x04, 0x08, 0x01, 0x10, 0x01, 0x32, 0xea, 0x01,
	...
	0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2e,
...
var file_step_proto_depIdxs = []int32{
	...
	10, // 25: proto.Status.result:type_name -> proto.StepResult
	...
	9,  // 29: proto.Step.Reference.specDef:type_name -> proto.SpecDefinition
	6,  // 30: proto.Step.Reference.paths:type_name -> proto.PathParts
	39, // 31: proto.Definition.OutputsEntry.value:type_name -> google.protobuf.Value
	29, // 32: proto.Spec.Content.inputs:type_name -> proto.Spec.Content.InputsEntry
	31, // 33: proto.Spec.Content.outputs:type_name -> proto.Spec.Content.OutputsEntry
	2,  // 34: proto.Spec.Content.output_method:type_name -> proto.OutputMethod
	30, // 35: proto.Spec.Content.InputsEntry.value:type_name -> proto.Spec.Content.Input
	3,  // 36: proto.Spec.Content.Input.type:type_name -> proto.ValueType
	39, // 37: proto.Spec.Content.Input.default:type_name -> google.protobuf.Value
	32, // 38: proto.Spec.Content.OutputsEntry.value:type_name -> proto.Spec.Content.Output
	3,  // 39: proto.Spec.Content.Output.type:type_name -> proto.ValueType
	39, // 40: proto.Spec.Content.Output.default:type_name -> google.protobuf.Value
	39, // 41: proto.StepResult.OutputsEntry.value:type_name -> google.protobuf.Value
	13, // 42: proto.StepRunner.Run:input_type -> proto.RunRequest
	15, // 43: proto.StepRunner.Close:input_type -> proto.CloseRequest
	17, // 44: proto.StepRunner.FollowLogs:input_type -> proto.FollowLogsRequest
	20, // 45: proto.StepRunner.Status:input_type -> proto.StatusRequest
	14, // 46: proto.StepRunner.Run:output_type -> proto.RunResponse
	16, // 47: proto.StepRunner.Close:output_type -> proto.CloseResponse
	18, // 48: proto.StepRunner.FollowLogs:output_type -> proto.FollowLogsResponse
	21, // 49: proto.StepRunner.Status:output_type -> proto.StatusResponse
